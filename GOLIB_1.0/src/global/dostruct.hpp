...
#ifndef MC__DOSTRUCT_HPP
#define MC__DOSTRUCT_HPP
...
class DOSTRUCT: public ODESTRUCT
{
public:
  //! @brief Infinity
  static double INF;
...
public:
  ...
  DOSTRUCT
    ( const unsigned int np, const unsigned int nx, const unsigned int nc=0,
      const unsigned int ni=0 )
    : ODESTRUCT(np,nx,ni), _nc(nc)
    {}
